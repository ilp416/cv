...
# С 2020 по настроящий момент [Belodezhda.ru] Брест, Беларусь (част. удаленно)
Belodezhda - интернет магазин женской одежды. В Бресте существует огромное кол-во швейных фабрик, компания выполняет роль аггрегатора и продает модели более чем 100 брендов в Беларуси, Украине и России.
...
# 2020-2022 [myDog.show] Собственный маленький проект
mydog.show - Сервис регистрации на выставки собак. Наиболее сложная задача для клубов собаководства – это составление каталога, т.к. там довольно сложные правила группировки и большинство клубов делали это в ручную. Но участники выставок обычно регистрируются как можно позже, и есть проблема – закрыть регистрацию как можно позже, но успеть отдать в типографию сверстаный каталог. С помощью моего сервиса верстка каталога занимала считанные минуты, а так же закрывались другие задачи клубов.

*features:*
  * Генерирование каталогов в формате *.docx
  * Генерирование дипломов и карт описаний
  * Парсинг данных из гугл форм в БД
  * Онлайн-каталог с быстрым поиском на странице

*Технологии:* Rails 6, postresql, react, Ubuntu-server, Gitlab, Rspec, Sidekiq
